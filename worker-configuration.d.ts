/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 00a7dfda43815b8368f8158ca2960b32)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		LUMANTIC_SLACK_BOT_TOKEN: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_PASSWORD" | "LUMANTIC_SLACK_BOT_TOKEN">> {}
}
